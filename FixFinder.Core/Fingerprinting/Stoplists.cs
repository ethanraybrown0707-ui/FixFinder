...
/// <summary>
/// Words that appear in almost every error message and therefore distinguish none of them.
/// </summary>
/// <remarks>
/// Fixed and inspectable rather than learned. With no model in the loop, a person tuning a
/// search needs to be able to read the list and see why a word was dropped - and to add one
/// when a particular project's noise is not covered here.
/// <para>
/// The list is deliberately conservative about <i>technical</i> words. "null", "reference",
/// "index" and "type" are common, but they also carry real meaning in an error message, so they
/// stay. Only words that are pure connective tissue or pure error-boilerplate are removed.
/// </para>
/// </remarks>
public static class Stoplists
{
    ...
    {
        // Error boilerplate - present whatever went wrong.
        ...
        // Words that look meaningful but say nothing about which error this is.
    ...
    /// <summary>
    /// Scores a token's usefulness as a search term.
    /// </summary>
    /// <remarks>
    /// No corpus and no learning - three readable rules. Long tokens carry more information
    /// than short ones; an identifier in CamelCase or snake_case is almost always the specific
    /// thing that broke; boilerplate is worth nothing.
    /// </remarks>
    ...
    /// <summary>True for CamelCase, snake_case, dotted or otherwise code-shaped tokens.</summary>
