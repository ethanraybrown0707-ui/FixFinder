...
/// <summary>Builds one Go file the way <c>go build</c> does, by running the compiler and linker it runs with the arguments it
/// passes - without the go command's own start-up in front of them.</summary>
