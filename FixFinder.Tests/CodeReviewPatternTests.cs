...
/// <summary>
/// The logic and style patterns: each case is found where the mistake is and fixed as shown (lines separated by ¦), found with no fix to offer (FOUND),
/// or left alone (null) where the same shape is right.
/// </summary>
