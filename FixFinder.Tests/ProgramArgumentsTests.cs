...
/// <summary>
/// Passing a program the arguments it reads, so a program that needs them gets past its first line.
/// </summary>
public class ProgramArgumentsTests : IDisposable
{
    ...
    public async Task ACSharpProgramRunByTheSdkGetsItsArgumentsRatherThanTheSdk()
    {
        ...
        // --help would make dotnet print its own help and exit 0 if it reached dotnet rather than the program.
