...
/// <summary>Logic errors - programs that run to the end and do the wrong thing: the comparison with expected output, the
/// suspiciousness formulas, the small edits tried, the mistakes recognised in code, and whole programs fixed for real.</summary>
