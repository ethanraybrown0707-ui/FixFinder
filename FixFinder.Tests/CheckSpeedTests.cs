...
/// <summary>
/// What makes checking a proposed fix quicker, and the proof that it answers exactly as before.
/// </summary>
/// <remarks>
/// Two shortcuts: MSVC's environment set up once instead of before every compile, and a check that
/// has already been compiled answered from memory. Either would be a bad trade if it ever changed a
/// verdict, so most of what is here is about when they must not apply.
/// </remarks>
