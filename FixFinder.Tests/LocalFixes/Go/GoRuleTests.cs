...
/// <summary>The Go mistakes of a beginner, of someone arriving from another language, and of later years - each rule's fix and
/// refusals from the Go compiler's and runtime's words - and the compiler parser that reads them.</summary>
public class GoRuleTests : IDisposable
{
    ...
    [InlineData("go-unclosed-string", "newline in string", "\tfmt.Println(\"hello)\n", 1, "\tfmt.Println(\"hello\")")]
