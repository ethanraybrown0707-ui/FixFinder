...
/// <summary>The C++ mistakes of someone learning it, and of someone arriving from Java, C# or Python: each rule's fix and
/// refusals from g++'s and MSVC's own words, and the shared C rules reading C++.</summary>
public class CppBasicsTests : IDisposable
{
