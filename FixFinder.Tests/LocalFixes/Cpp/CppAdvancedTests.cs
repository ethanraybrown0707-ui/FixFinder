...
/// <summary>The C++ mistakes of later years - inheritance and virtual functions, templates, smart pointers, lambdas, const,
/// threads - each rule's fix and refusals from g++'s and MSVC's words.</summary>
public class CppAdvancedTests : IDisposable
{
