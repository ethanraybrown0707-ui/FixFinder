...
/// <summary>C++ programs broken the way beginners and later-year students break them, built and run for real with g++, with MSVC,
/// and rebuilt under AddressSanitizer - each must end with its rule's fix, checked and ready to copy.</summary>
public class CppLiveTests
{
    private const string Dog = "class Dog {\npublic:\n    int age = 3;\n};\n\n";

    private static string ProgramWith(string body, string includes = "#include <iostream>\n", string extra = "") =>
        includes + "\n" + extra + "int main() {\n" + body + "    return 0;\n}\n";
