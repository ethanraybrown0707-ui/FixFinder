...
/// <summary>The C# mistakes of later years - interfaces, inheritance, properties, LINQ, exceptions, switch - each rule's fix and
/// refusals from Roslyn's own messages, then the same programs built for real.</summary>
public class CSharpAdvancedTests : IDisposable
{
