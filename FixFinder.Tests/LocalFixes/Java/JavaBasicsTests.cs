...
/// <summary>The Java mistakes a beginner makes: each rule's fix and refusals from javac's own output - message, echo, caret and
/// notes - then the same programs compiled for real.</summary>
public class JavaBasicsTests : IDisposable
{
