...
/// <summary>The Java mistakes of later years - inheritance, interfaces, generics, collections, exceptions - each rule's fix and
/// refusals from javac's own output, then the same programs compiled for real.</summary>
public class JavaAdvancedTests : IDisposable
{
