...
/// <summary>C and C++ mistakes that run without failing - found from the build's warnings, or by running the program again under
/// AddressSanitizer - each ending with its fix, checked and ready to copy.</summary>
