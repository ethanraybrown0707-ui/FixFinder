...
/// <summary>The JavaScript mistakes of a beginner, of someone arriving from Python, Java or C#, and of later years - each rule's
/// fix and refusals from Node's own words, and what the Node parser now reads above the stack.</summary>
public class JavaScriptRuleTests : IDisposable
{
