...
/// <summary>A class that never writes a member its interface or abstract base requires, built for real in C#, Java and C++ - each
/// must end with that member added, with the declared signature and a body that says it is not written yet.</summary>
