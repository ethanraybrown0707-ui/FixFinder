...
/// <summary>The C mistakes neither compiler fixes by itself: each rule's fix and refusals from MSVC's, gcc's and
/// AddressSanitizer's own words, then the same programs built for real with gcc and with MSVC.</summary>
public class CBasicsTests : IDisposable
{
