...
/// <summary>
/// Programs made of more than one file - run as the whole of themselves, and fixed in whichever file the mistake is in,
/// with the fix checked against the whole program.
/// </summary>
/// <remarks>
/// Live, and each case skips when its toolchain is missing. The C, C++ and Go cases run a freshly built program, which
/// Application Control can refuse on a machine enforcing it.
/// </remarks>
public class MultiFileProgramTests
{
    ...
    /// <summary>The toolchain, the files, the one chosen, and what it prints.</summary>
    ...
    /// <summary>The toolchain, the files, the one chosen, the rules that may fix it, and text the copied fix must contain - for a mistake in another file.</summary>
