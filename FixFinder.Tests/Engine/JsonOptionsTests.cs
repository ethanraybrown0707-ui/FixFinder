...
/// <summary>Placeholder coverage that keeps the test project honest from M0 onwards: it proves the Core reference resolves and
/// that the shared serializer options are actually shared.</summary>
